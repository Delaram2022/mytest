...
BOARD_SIZE = 3
DEFAULT_PLAYERS = (Player(label="X", color="blue"), Player(label="O", color="red"),)
...
class Game:
    ...
    def process_move(self, move):
        ...
        # TODO: check whether the current move leads to a winning combos.
